 ...
 *      1) Split the list and
 *      2) merge the list(During merging sorting takes place)
 *      3) merge sort
 *
 *
 *  Time Complexity: O(n log n)
 *  Stable: Equal elements won't be rearranged
 *  Not Adaptive: Due to recursion, it loose the handle and can not break out early
 *  Space: O(n) extra space [This is big trade off], that's why quick sort is preferred O(log n)
 */
